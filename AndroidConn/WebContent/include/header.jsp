	          ...
	          <div class="right">
	            <nav>
	              <ul class="test">
	                ...
	                <li><a href="order.do"><cufon class="cufon cufon-canvas" alt="Order List" style="width: 50px; height: 18px;"><canvas width="58" height="22" style="width: 58px; height: 22px; top: -2px; left: -1px;"></canvas><cufontext>Order List</cufontext></cufon></a></li>
	                <li class="tag1"><a href="complete.do"><cufon class="cufon cufon-canvas" alt="Complete Order List" style="width: 73px; height: 18px;"><canvas width="82" height="22" style="width: 82px; height: 22px; top: -2px; left: -1px;"></canvas><cufontext>Complete Order List</cufontext></cufon></a></li>
