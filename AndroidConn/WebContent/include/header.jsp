	          ...
	          <div class="right">
	            <nav>
	              <ul class="test">
	                ...
	                <li><a href="ProductListForm.do"><cufon class="cufon cufon-canvas" alt="Product Registration" style="width: 72px; height: 18px;"><canvas width="79" height="22" style="width: 79px; height: 22px; top: -2px; left: -1px;"></canvas><cufontext>Product Registration</cufontext></cufon></a></li>
	              </ul>
	            </nav>
